...
open('/home/lluc/Documents/ME16IN/devset/scripts/me16in_wien_image_fc7.txt', 'w').close()
f = open('/home/lluc/Documents/ME16IN/devset/scripts/me16in_wien_image_fc7.txt', 'a')
...
for i in range(total_video_num_devtest, total_video_num_devtest + total_video_num_testset):
    ...
    l.set_results(i, res, prob, f, 'fc7')
